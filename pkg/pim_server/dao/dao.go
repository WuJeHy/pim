...
//func (d *Dao) GetChatInfoByID(myUserID int64, chatID int64) (info *models.ChatInfoDataType, err error) {
//	//TODO implement me
//	//panic("implement me")
//
//	// 检查用户ID是否合法
...
//	// 有数据库 这是一个json
//
//	info = new(models.ChatInfoDataType)
//
//	// 将redis返回的数据包装成一个对象
...
//	GetChatInfoByID(myUserID int64, chatID int64) (info *models.ChatInfoDataType, err error)
//}
